        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Vielen Dank für Ihre Bestellung bei Aroma Siegen",
                style: GoogleFonts.raleway(
                  fontSize: 15,
                  color: purple_light,
              ...
              Flexible(
                child: SizedBox(
                  child: Text(
                    "Wir haben ihre Bestellung erhalten und legen sofort los mit der Zubereitung Ihrer Speisen." +
                        "Sie erhalten nochmal eine Bestätigung per Email zugesendet. Sollten Sie einen Fehler bemerken oder uns" +
                        "gerne noch etwas zu ihrer Bestellung mitteilen wollen, könnnen Sie dies gerne unter der              " +
                        "0271 / 38 75 06 13 tun.",
                    style: GoogleFonts.raleway(
                      fontSize: 13,
                      color: purple_light,
