...
class SauceMultiSelectDialogItem<Indigrends> {
  const SauceMultiSelectDialogItem(this.value, this.label);

  final Indigrends value;
  final String label;
}

class SauceMultiSelectDialog<Indigrends> extends StatefulWidget {
  SauceMultiSelectDialog({
    Key key,
    this.items,
  ...
  final List<SauceMultiSelectDialogItem<Indigrends>> items;
  ...
  State<StatefulWidget> createState() =>
      _SauceMultiSelectDialogState<Indigrends>();
}

class _SauceMultiSelectDialogState<Indigrends>
    extends State<SauceMultiSelectDialog<Indigrends>> {
  ...
  Widget _buildItem(SauceMultiSelectDialogItem<Indigrends> item) {
