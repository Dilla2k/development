...
class SauceSingleSelectDialogItem<Indigrends> {
  const SauceSingleSelectDialogItem(this.value, this.label);

  final Indigrends value;
  final String label;
}

class SauceSingleSelectDialog<Indigrends> extends StatefulWidget {
  SauceSingleSelectDialog({
    Key key,
    this.items,
  ...
  final List<SauceSingleSelectDialogItem<Indigrends>> items;
  ...
  State<StatefulWidget> createState() =>
      _SauceSingleSelectDialogState<Indigrends>();
}

class _SauceSingleSelectDialogState<Indigrends>
    extends State<SauceSingleSelectDialog<Indigrends>> {
  ...
  Widget _buildItem(SauceSingleSelectDialogItem<Indigrends> item) {
