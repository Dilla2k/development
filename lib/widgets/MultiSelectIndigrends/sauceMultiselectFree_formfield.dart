...
import 'sauceMultiselectFree_dialog.dart';

class SauceMultiSelectFreeFormField extends FormField<dynamic> {
          ...
          builder: (FormFieldState<dynamic> state) {
            ...
            return InkWell(
              onTap: () async {
                ...
                final items = List<SauceMultiSelectFreeDialogItem<Indigrends>>();
                dataSource.forEach((item) {
                  items.add(SauceMultiSelectFreeDialogItem(item,
                ...
                List selectedValues = await showDialog<List>(
                  ...
                  builder: (BuildContext context) {
                    return SauceMultiSelectFreeDialog(
                      title: titleText,
